...
def create_IQ_modulator_folded(
    ...
    # add arc waveguide
    arc_waveguide_ref.connect("o1", destination=c.ports["optical_out"])
    ...
    c.add_port("final_optical_out", port=straight_waveguide_ref.ports["o2"])
