...
from PSI_PDK import create_straight_mzm_2x1_wg as mzm
...
def create_QPSK_modulator_folded(
    ...
    arc_waveguide_radius=100,  # New parameter for the radius of the arc waveguide
    #waveguide_bottom_output_waveguide_length=500  # New parameter for the length of the straight waveguide
    ...
    """
    c = gf.Component("IQ modulator folded")
    ...
    # Create the leftmost input MMI (2x2 splitter)
    mmi_input = gf.components.mmi2x2(
    ...
    mzm_top_ref.movey( waveguide_yspacing / 2 +first_sbends_gap)

    mzm_bottom_ref.movex(waveguide_left_length+mmi_length+mmi_length_taper + waveguide_sbend_input_geom[0]+ mmi_length_taper)
    mzm_bottom_ref.movey(- waveguide_yspacing / 2 -first_sbends_gap)

    # Create S-bends for input connections
    cs = gf.cross_section.cross_section(width=waveguide_width, layer=waveguide_layer_num)
    bendS_input_top = gf.components.bend_s(size=[waveguide_sbend_input_geom[0], waveguide_sbend_input_geom[1]], cross_section=cs)  
    bendS_input_bottom = gf.components.bend_s(size=[waveguide_sbend_input_geom[0], -waveguide_sbend_input_geom[1]], cross_section=cs)
    bendS_top_input_top = gf.components.bend_s(size=[waveguide_sbend_input_geom[0], -waveguide_sbend_input_geom[1]], cross_section=cs)  
    bendS_bottom_input_bottom = gf.components.bend_s(size=[waveguide_sbend_input_geom[0], waveguide_sbend_input_geom[1]], cross_section=cs)

    # Connect input MMI to MZMs via bends
    bendS_input_top_ref = c << bendS_input_top
    bendS_input_top_ref.connect("o1", destination=mmi_input_ref.ports["o3"])
    ...
    bendS_input_bottom_ref.connect("o1", destination=mmi_input_ref.ports["o4"])
    bendS_input_bottom_ref.connect("o2", destination=mzm_bottom_ref.ports["o2"])
    # bendS_input_bottom_ref.movex(mmi_length_taper+mmi_length)

    bendS_left_input_mmi_top = gf.components.bend_s(size=[waveguide_sbend_input_geom[0], -waveguide_sbend_input_geom[1]], cross_section=cs)  
    bendS_left_input_mmi_bottom = gf.components.bend_s(size=[waveguide_sbend_input_geom[0], waveguide_sbend_input_geom[1]], cross_section=cs)



    # Create S-bends for the output side (mirrored)
    bendS_output_top = gf.components.bend_s(size=[waveguide_sbend_input_geom[0], waveguide_sbend_input_geom[1]+first_sbends_gap], cross_section=cs)
    bendS_output_bottom = gf.components.bend_s(size=[waveguide_sbend_input_geom[0], -waveguide_sbend_input_geom[1]-first_sbends_gap], cross_section=cs)
    ...
    input_waveguide_up = gf.components.straight(length=waveguide_left_length, width=waveguide_width, layer=waveguide_layer_num)
    input_waveguide_ref_up = c << input_waveguide_up
    input_waveguide_bottom = gf.components.straight(length=waveguide_left_length, width=waveguide_width, layer=waveguide_layer_num)
    input_waveguide_ref_bottom = c << input_waveguide_bottom
    input_waveguide_ref_up.connect("o2", destination=mmi_input_ref.ports["o2"])
    input_waveguide_ref_bottom.connect("o2", destination=mmi_input_ref.ports["o1"])

    bendS_top_input_top_ref = c << bendS_top_input_top
    bendS_top_input_top_ref.movex(mmi_length + mmi_length_taper+sbend_input_geom[0])
    bendS_top_input_top_ref.movey(mmi_length + mmi_length_taper+sbend_input_geom[1]+first_sbends_gap/2)
    bendS_top_input_top_ref.connect("o2", destination=mzm_top_ref.ports["o2"])
    # bendS_top_input_top_ref.connect("o2", destination=input_waveguide_ref_up.ports["o1"])

    bendS_bottom_input_bottom_ref = c << bendS_bottom_input_bottom
    bendS_bottom_input_bottom_ref.movex(mmi_length + mmi_length_taper+sbend_input_geom[0])
    bendS_bottom_input_bottom_ref.movey(sbend_input_geom[1] -first_sbends_gap/2)
    bendS_bottom_input_bottom_ref.connect("o2", destination=mzm_bottom_ref.ports["o1"])
    # bendS_bottom_input_bottom_ref.connect("o2", destination = input_waveguide_ref_bottom.ports["o1"])

    bendS_left_input_mmi_top_ref = c << bendS_left_input_mmi_top
    bendS_left_input_mmi_top_ref.movex(-mmi_length_taper-waveguide_left_length)
    bendS_left_input_mmi_top_ref.movey(first_sbends_gap/2)
    bendS_left_input_mmi_top_ref.connect("o2", destination=input_waveguide_ref_up.ports["o1"])

    bendS_left_input_mmi_bottom_ref = c << bendS_left_input_mmi_bottom
    bendS_left_input_mmi_bottom_ref.movex(-mmi_length_taper-waveguide_left_length)
    bendS_left_input_mmi_bottom_ref.movey(-first_sbends_gap/2)
    bendS_left_input_mmi_bottom_ref.connect("o2", destination=input_waveguide_ref_bottom.ports["o1"])
    ...
    c.add_port("optical_in_up", port=bendS_left_input_mmi_top_ref.ports["o1"])
    c.add_port("optical_in_middle_up", port=bendS_top_input_top_ref.ports["o1"])
    c.add_port("optical_in_middle_down", port= bendS_bottom_input_bottom_ref["o1"])
    c.add_port("optical_in_down", port=bendS_left_input_mmi_bottom_ref.ports["o1"])
    ...
    electrode_top_MZM.movey( waveguide_yspacing / 2 + first_sbends_gap)
    ...
    electrode_bottom_MZM.movey(- waveguide_yspacing / 2 - first_sbends_gap)
    ...
    electrode_launch_ref_top_MZM.movey(waveguide_yspacing / 2+ (electrode_launch_radius-electrode_launch_outer_width -electrode_launch_gap - (electrode_launch_inner_width)/2)+ first_sbends_gap)

    c.add_port("electrode_launch_ref_top_MZM_ground1", port= electrode_launch_ref_top_MZM.ports["port1"], port_type="electrical")
    c.add_port("electrode_launch_ref_top_MZM_signal", port= electrode_launch_ref_top_MZM.ports["port2"], port_type="electrical")
    c.add_port("electrode_launch_ref_top_MZM_ground2", port= electrode_launch_ref_top_MZM.ports["port3"], port_type="electrical")  
    ...
    electrode_launch_ref_bottom_MZM.movey(- waveguide_yspacing / 2 - (electrode_launch_radius-electrode_launch_outer_width -electrode_launch_gap - (electrode_launch_inner_width)/2)-first_sbends_gap)
 
    c.add_port("electrode_launch_ref_bottom_MZM_ground1", port= electrode_launch_ref_bottom_MZM.ports["port1"], port_type="electrical")
    c.add_port("electrode_launch_ref_bottom_MZM_signal", port= electrode_launch_ref_bottom_MZM.ports["port2"], port_type="electrical")
    c.add_port("electrode_launch_ref_bottom_MZM_ground2", port= electrode_launch_ref_bottom_MZM.ports["port3"], port_type="electrical")  

    # Create and place the heater
    heater_ref_input_top = c.add_ref(heater(
    ...
    heater_ref_input_top.movex(mmi_length_taper + mmi_length + mmi_length_taper + waveguide_sbend_input_geom[0] )
    heater_ref_input_top.movey( waveguide_yspacing / 2 + first_sbends_gap + first_sbends_gap)

    c.add_port("heater_ref_input_top_left", port= heater_ref_input_top.ports["port1"], port_type="electrical")
    c.add_port("heater_ref_input_top_right", port= heater_ref_input_top.ports["port2"], port_type="electrical")

    heater_ref_input_bottom = c.add_ref(heater(
        only_heater=heater_only_heater, 
        heater_length=heater_length, 
        heater_width=heater_width, 
        pad_width=heater_pad_width, 
    ...
    heater_ref_input_bottom.movex(mmi_length_taper + mmi_length + mmi_length_taper + waveguide_sbend_input_geom[0] )
    heater_ref_input_bottom.mirror((0,0),(1,0))
    heater_ref_input_bottom.movey( -waveguide_yspacing / 2 - first_sbends_gap - first_sbends_gap)

    c.add_port("heater_ref_input_bottom_left", port= heater_ref_input_bottom.ports["port1"], port_type="electrical")
    c.add_port("heater_ref_input_bottom_right", port= heater_ref_input_bottom.ports["port2"], port_type="electrical")
    ...
    heater_ref_top_MZM_top.movey( waveguide_yspacing / 2 + waveguide_sbend_geom[1] + second_sbens_gap/2 + (waveguide_width/2)*2 + first_sbends_gap  )

    c.add_port("heater_ref_top_MZM_top_left", port= heater_ref_top_MZM_top.ports["port1"], port_type="electrical")
    c.add_port("heater_ref_top_MZM_top_right", port= heater_ref_top_MZM_top.ports["port2"], port_type="electrical")
    ...
    heater_ref_top_MZM_bottom.movey( waveguide_yspacing / 2 - waveguide_sbend_geom[1] - second_sbens_gap/2 - (waveguide_width/2)*2 + first_sbends_gap )

    c.add_port("heater_ref_top_MZM_bottom_left", port= heater_ref_top_MZM_bottom.ports["port1"], port_type="electrical")
    c.add_port("heater_ref_top_MZM_bottom_right", port= heater_ref_top_MZM_bottom.ports["port2"], port_type="electrical")
    ...
    heater_ref_bottom_MZM_top.movey( -waveguide_yspacing / 2 + waveguide_sbend_geom[1] + second_sbens_gap/2 + (waveguide_width/2)*2 - first_sbends_gap )

    c.add_port("heater_ref_bottom_MZM_top_left", port= heater_ref_bottom_MZM_top.ports["port1"], port_type="electrical")
    c.add_port("heater_ref_bottom_MZM_top_right", port= heater_ref_bottom_MZM_top.ports["port2"], port_type="electrical")    
    ...
    heater_ref_bottom_MZM_bottom.movey( -waveguide_yspacing / 2 - waveguide_sbend_geom[1] - second_sbens_gap/2 - (waveguide_width/2)*2 - first_sbends_gap  )

    c.add_port("heater_ref_bottom_MZM_bottom_left", port= heater_ref_bottom_MZM_bottom.ports["port1"], port_type="electrical")
    c.add_port("heater_ref_bottom_MZM_bottom_right", port= heater_ref_bottom_MZM_bottom.ports["port2"], port_type="electrical")  
    ...
    # add arc waveguide
    arc_waveguide_ref.connect("o1", destination=output_waveguide_ref.ports["o2"])

    # add straight waveguide
    straight_waveguide = gf.components.straight(length = waveguide_left_length + mmi_length_taper + mmi_length + mmi_length_taper + waveguide_sbend_input_geom[0] +waveguide_right_length + mmi_length_taper + mmi_length + mmi_length_taper + waveguide_sbend_geom [0] + waveguide_length_of_MZM*1000+ waveguide_sbend_geom[0] + mmi_length_taper + mmi_length + mmi_length_taper + waveguide_left_length + waveguide_sbend_input_geom[0]+mmi_length_taper + mmi_length+ mmi_length_taper + waveguide_left_length,width=waveguide_width, layer=waveguide_layer_num)
    straight_waveguide_ref = c << straight_waveguide

    # connect straight waveguide to arc waveguide's output port
    straight_waveguide_ref.connect("o1", destination=arc_waveguide_ref.ports["o2"])

    # add ports for the new waveguide
    c.add_port("optical_out", port=straight_waveguide_ref.ports["o2"])
